    ...
    <div class="container-inner">
        <div id="comments" class="comments-area">
            ...
            $comments_args = array(
                ...
                'fields' => $fields,
                'comment_field' => '<p class="comment-form-comment"><label for="comment">' . __('') . '</label><br /><textarea id="comment" class="text-area-comment" name="comment" aria-required="true" cols="30" rows="12"></textarea></p>',
